...
class Modal extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            pictures: [{ src: 'https://source.unsplash.com/random?food', caption: 'This is a test caption for Soup' }, { src: 'https://source.unsplash.com/random?food', caption: 'This is a test caption for Salad' }, { src: 'https://source.unsplash.com/random?food', caption: 'This is a test caption for Chicken' }, { src: 'https://source.unsplash.com/random?food', caption: 'This is a test caption for Desert' }],
            previousDish: '',
    ...
    render() {
        ...
        return (
            <div className={styles.container} onClick={this.props.closeModal}>
                ...
                {this.state.dishIndex !== 0 && <div className={styles.previousDish} onClick={this.previousDish}><span>{this.state.previousDish}</span> <LeftScrollIcon fill='white' /></div>}
                {this.state.dishIndex !== this.state.dishes.length - 1 && <div className={styles.nextDish} onClick={this.nextDish}><span>{this.state.nextDish}</span> <RightScrollIcon fill='white' /></div>}
            </div>
        )
    }
}
